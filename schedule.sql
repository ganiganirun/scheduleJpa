...
ALTER TABLE schedule ADD COLUMN member_id BIGINT NOT NULL COMMENT '와래키';

ALTER TABLE schedule ADD CONSTRAINT fk_member FOREIGN KEY (member_id) REFERENCES member(id);
